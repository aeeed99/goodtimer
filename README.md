...
goodtimer provides a clean way to implement `setTimeout` and `setInterval`, and provides a high-level API to easy manipulate countdowns. It comes with a flexible `timeExpression` syntax, so you can easily express time in a number of desireable ways.
...
- [Getting started with `Timer`](#-getting-started-with-timer)
  - [Callback function with `Timer`](#callback-function-with-timer)
  - [TimeExpressions](#timeexpressions)
  - [TimerOptions](#timeroptions)
  - [Ways to Get the time](#ways-to-get-the-time)
- [Getting Started with `Time`](#-getting-started-with-time)
  - [Creating a `Time` object](#creating-a-time-object)
- [Supporters](#clap-supporters)
