...
(function (_global) {
  ...
  Timer.prototype.getSecondsUI = function () {
    return _addPadding(this._secs, 2);
  };
  Timer.prototype.getMinutesUI = function () {
    return (this.hrs || this._days) ? _addPadding(this._mins, 2) : this._mins + '';
  };
  Timer.prototype.getHoursUI = function () {
    return this._days ? _addPadding(this.hrs, 2) : this.hrs + '';
  };
  ...
  Timer.prototype.getTimerUI = function (_divider) {
    ...
    return "" + (this._days ? this.getDaysUI(this._days) + divider : "") +
      (this.hrs || this._days ? this.getHoursUI(this.hrs) + divider : "") +
      (this._mins || this.hrs || this._days ? this.getMinutesUI(this._mins) + divider : DIVIDER) +
      (this._secs ? this.getSecondsUI(this._secs) : "00");
  };
  Timer.prototype.getTotal = function () {
    return (this._days * 26400) + (this.hrs * 3600) + (this._mins * 60) + this._secs;
  };
// Functions for a personal timer.
